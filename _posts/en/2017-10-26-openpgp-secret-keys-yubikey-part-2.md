...
I recommend you go through [the official store](https://www.yubico.com/product/yubikey-4-series/){:target="_blank" rel="nofollow noopener noreferrer"}
...
For those who have a Github account, there is a [promotional offer that allows to have -10%](https://www.yubico.com/github-special-offer/) on the cart. Interesting :){:target="_blank" rel="nofollow noopener noreferrer"}.
...
In addition, you can distribute your public key on [a key server](https://pgp.mit.edu/) and other services (GitHub, Kraken, keybase.io){:target="_blank" rel="nofollow noopener noreferrer"}.
This allows you to receive encrypted messages, and [sign your commits](https://help.github.com/articles/signing-commits-using-gpg/){:target="_blank" rel="nofollow noopener noreferrer"}
on GitHub (example on this commit [31dd621](https://github.com/eleven-labs/blog.eleven-labs.com/commit/31dd621db58a7ee1428bc9615c23e74d5ac98c3f)){:target="_blank" rel="nofollow noopener noreferrer"}.
...
- [wikipedia - Universal 2nd Factor](https://en.wikipedia.org/wiki/Universal_2nd_Factor){:target="_blank" rel="nofollow noopener noreferrer"}
- [fidoalliance -Universal 2nd Factor (U2F) Overview](https://fidoalliance.org/specs/fido-u2f-overview-ps-20150514.pdf){:target="_blank" rel="nofollow noopener noreferrer"}
- [YubiKey 4 series](https://www.yubico.com/products/yubikey-hardware/yubikey4/){:target="_blank" rel="nofollow noopener noreferrer"}
- [Yubico Expands FIPS Security Certification ](https://www.yubico.com/2016/05/yubikey-gains-support-for-higher-levels-of-federal-crypto-standards/){:target="_blank" rel="nofollow noopener noreferrer"}
- [wikipedia - FIPS 140-2](https://en.wikipedia.org/wiki/FIPS_140-2#Level_1){:target="_blank" rel="nofollow noopener noreferrer"}
- [Cryptographic Module Validation Program](https://csrc.nist.gov/projects/cryptographic-module-validation-program/Certificate/2267){:target="_blank" rel="nofollow noopener noreferrer"}
- [Guide to using YubiKey as a SmartCard for GPG and SSH](https://github.com/drduh/YubiKey-Guide){:target="_blank" rel="nofollow noopener noreferrer"}
- [RFC4880](https://tools.ietf.org/html/rfc4880){:target="_blank" rel="nofollow noopener noreferrer"}
- [Nitrokey Storage Got Great Results in a 3rd Party Security Audit](https://www.nitrokey.com/news/2015/nitrokey-storage-got-great-results-3rd-party-security-audit){:target="_blank" rel="nofollow noopener noreferrer"}
- [Secure Hardware vs. Open Source ](https://www.yubico.com/2016/05/secure-hardware-vs-open-source/){:target="_blank" rel="nofollow noopener noreferrer"}
- [Yubico has replaced all open-source components](https://www.reddit.com/r/linux/comments/4ls94a/yubico_has_replaced_all_opensource_components/){:target="_blank" rel="nofollow noopener noreferrer"}
- [Cover image source](https://www.yubico.com/press/images/){:target="_blank" rel="nofollow noopener noreferrer"}

### Remarks

This tutorial uses a Yubikey for storing secrets. Yubikey is the most popular key in the general public, especially
for the second authentication factor feature. There are other keys that support OpenPGP such as [NitroKey](https://www.nitrokey.com/){:target="_blank" rel="nofollow noopener noreferrer"}.
