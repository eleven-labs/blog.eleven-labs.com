...
First, you need to create a user account. Once our account is created, we start by creating a project and choose a main language for this project which will serve as a basis for translations. The same user can be part of several projects.
...
With all the filters available, it becomes easy to work on this interface without any issues.
