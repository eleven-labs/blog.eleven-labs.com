...
In iOS developpment, you will often find 2 principles :
    - delegates
    - closures (Swift) / blocks (Objective-C)
...
So, If now I call the method callWebService, considering the dummy code we produced, the result will be that we reach the method onRequestSuccess.
