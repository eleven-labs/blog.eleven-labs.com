...
La présentation a tourné autour de l'étude d'un cas pratique, en l'occurrence "[Socialite](https://github.com/10gen-labs/socialite){:target="_blank" rel="nofollow"}" un réseau social proposant des fonctionnalités proches de Twitter.
...
[Lien de la présentation](http://fr.slideshare.net/mongodb/socialite-the-open-source-status-feed){:target="_blank" rel="nofollow"}
...
[Lien vers les slides](http://fr.slideshare.net/mongodb/plus-de-flexibilit-et-de-scalabilit-chez-bouygues-tlcom-grce-mongodb){:target="_blank" rel="nofollow"}
...
[Lien vers les slides](http://fr.slideshare.net/mongodb/mongodb-day-paris2014hadooptgrall-1){:target="_blank" rel="nofollow"}
...
[Lien de la présentation](http://fr.slideshare.net/mongodb/mongo-db-days-paris-2014-mms-fr){:target="_blank" rel="nofollow"}
...
Vous pouvez aussi trouver toutes les speaks des précédents événements à cette [adresse](http://www.mongodb.com/presentations/){:target="_blank" rel="nofollow"}
