...
La suite de la conférence nous permet de mettre en place notre première push notification, je vous invite à voir ce [code lab](https://developers.google.com/web/fundamentals/getting-started/push-notifications/){:target="_blank" rel="nofollow"}.
...
Le second réflexe à avoir pour améliorer l'accessibilité de votre PWA est de mettre en place la norme ARIA que vous pouvez retrouver sur le site [W3C](https://www.w3.org/WAI/intro/aria.php){:target="_blank" rel="nofollow"}.
...
Certainement l'une des meilleures conférences de la journée, Jefferey Posnick nous montre comment mettre en place sa première PWA en s'aidant de l'extension [LightHouse](https://github.com/GoogleChrome/lighthouse){:target="_blank" rel="nofollow"}.
Pour cela, il utilise un projet Github qu'il passe étape par étape pour améliorer le score sur LightHouse.

- Isomorphique [https://github.com/GoogleChrome/sw-precache/compare/step1...step2](https://github.com/GoogleChrome/sw-precache/compare/step1...step2){:target="_blank" rel="nofollow"}
- Service worker [https://github.com/GoogleChrome/sw-precache/compare/step2...step3](https://github.com/GoogleChrome/sw-precache/compare/step2...step3){:target="_blank" rel="nofollow"}
- Manifest [https://github.com/GoogleChrome/sw-precache/compare/step3...step4](https://github.com/GoogleChrome/sw-precache/compare/step3...step4){:target="_blank" rel="nofollow"}

<iframe width="590" height="332" src="https://www.youtube.com/embed/LZjQ25NRV-E" frameborder="0" allowfullscreen></iframe>

### Autres conférences

Les autres conférences étant assez redondantes, je vous invite à voir les vidéos disponibles [ici](https://www.youtube.com/playlist?list=PLNYkxOF6rcIAWWNR_Q6eLPhsyx6VvYjVb){:target="_blank" rel="nofollow"}.
Vous pouvez aussi faire les différents code lab disponibles [ici](https://codelabs.developers.google.com/?cat=Web){:target="_blank" rel="nofollow"}, qui vous permettrons de mettre en place votre première PWA.
Pour voir des exemples de PWA, un site dédié à été mis en place [ici](https://pwa.rocks/){:target="_blank" rel="nofollow"}.
