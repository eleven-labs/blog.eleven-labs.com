...
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/2022-03-04-phpstorm-tips-config-extensions/PhpStorm_Icon.png" width="300px" alt="PhpStorm Logo" style="display: block; margin: auto;"/>
    <i>PhpStorm</i>
</div>

<br />

Nous irons crescendo dans cet article du tips le plus au moins connu, le meilleur se trouvant à la fin, donc restez bien jusqu'au bout (oui, j'optimise mon readtime). Commençons par les extensions très utiles que je possède.

## Key promoter

Comme vous le savez certainement si vous utlisez PhpStorm, les raccourcis clavier, c'est la vie. Ce sont eux qui permettent de déployer toute la puissance de votre IDE.
...
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/2022-03-04-phpstorm-tips-config-extensions/key-promoter-notification.png" width="300px" alt="PhpStorm Logo" style="display: block; margin: auto;"/>
    <i>Key Promoter</i>
</div>

<br />

Comme vous le voyez, dès que vous exécuterez une action pour laquelle il existe un raccourci clavier, Key Promoter va vous afficher une petite notification ennuyeuse en bas à droite de votre IDE. POur vour rappeler que vous êtes nuls car vous avez manuellement copié un fichier au lieu de faire un Ctrl+c par exemple.
...
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/2022-03-04-phpstorm-tips-config-extensions/code-glance-example.png" width="300px" alt="PhpStorm Logo" style="display: block; margin: auto;"/>
    <i>Code Glance</i>
</div>

<br />

Très pratique, on s'en rend compte surtout à l'utilisation, très rapidement on ne peut plus s'en passer.
...
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/2022-03-04-phpstorm-tips-config-extensions/phpstorm-clean.png" width="300px" alt="PhpStorm Logo" style="display: block; margin: auto;"/>
...
Pour afficher / faire disparaître votre arborescence de fichier, utiliser **Alt + 1**.
Et pas de panique si vous pensez avoir perdu tout accès à votre **Main Menu**, j'y arrive dans un instant.
</div>

Je vous arrête tout de suite, j'ai moi aussi trouvé ça un peu flippant au début. Je me sentais un peu perdu sans toutes ces options qui nous rassure autour de nous.
...
Laissez-moi votre nouveau meilleur ami...

## Surutilisez le menu d'actions

Vous souhaitez réafficher votre barre de menu ? Simple, *Ctrl + Maj + A* puis tapez "Main menu". VOus trouverez votre bonheur.

Besoin de changer les onglets de place ? *Ctrl + Maj + A* => "Tab placement".

Ouvrir un nouveau fichier / projet ? *Ctrl + Maj + A* => "Open...".

Etc... Pour **TOUTES** les actions auxquelles vous pensez dont vous ne vous souvenez plus du raccourci ou qui n'en ont tout simplement pas, il suffit d'ouvrir votre menu d'actions avec *Ctrl + Maj + A* et d'écrire ce que vous voulez faire. L'utilisation de ce menu prend tout son sens quand on est débarrassé de toutes nos taskbar. Je trouve son utilisation même plus rapide que les barres de tâches : Plutôt que de fouiller dans une arborescence d'options ou même de ne plus savoir où chercher, le menu d'actions trouve votre option en quelques caractères tapés au clavier.

## Distraction mode free, aka le boss de fin
...
<div style="text-align: center;">
    <img src="{{ site.baseurl }}/assets/2022-03-04-phpstorm-tips-config-extensions/distraction-free-mode.png" width="300px" alt="PhpStorm Logo" style="display: block; margin: auto;"/>
...
<div  class="admonition important"  markdown="1"><p  class="admonition-title">Important</p>
Pour l'activer, je vous le donne en mille : un petit coup de *Ctrl + Maj + A* => "Distraction mode"
</div>

Si vous avez préféré ne pas vous séparer de vos taskbars et menus, le distraction mode vous les enlevera totalement pour le temps où vous souhaitez rester focus, ce qui peut être un bon compromis si vous ne souhaitez travailler ainsi que quelques instants.
Autre avantage, le distraction free mode va quelque peut centrer votre code plutôt que de le laisser tout collé à gauche comme il le fait habituellement quand on se contente de fermer l'arborescence de fichiers, et c'est très agréable.

Le distraction free mode retire beaucoup de choses, mais vous pouvez le personnaliser si besoin.

Par exemple, si comme moi vous ne pouvez pas vous passer des numéros de lignes : *Ctrl + Maj + A* => "Show line numbers".

Vous commencez à comprendre la chanson !
