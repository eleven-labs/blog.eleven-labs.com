...
*“La dette technique est une* *métaphore* *du* *développement* *logiciel* *inventée par* [*Ward Cunningham*](https://fr.wikipedia.org/wiki/Ward_Cunningham){:target="_blank" rel="nofollow noopener noreferrer"}*. Il s'inspire du concept existant de* *dette* *dans le contexte du financement des entreprises et l'applique au domaine du développement logiciel.”*
