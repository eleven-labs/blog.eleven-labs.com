...
Si vous avez fait un peu attention, vous avez vu que dans le fichier `.env` il y a d'autres variables, c'est parce que l'application utilise [docker](https://www.docker.com/){:target="_blank" rel="nofollow"}.
...
Comme vous pouvez le constater nous allons utiliser [Webpack](https://webpack.github.io/docs/)  pour compiler et préparer nos fichiers javascript. Vous avez aussi en fin du fichier la configuration de [Jest](https://facebook.github.io/jest/){:target="_blank" rel="nofollow"} qui sera l'outil qui va nous permettre de mettre en place les tests unitaires et les tests visuels de notre application javascript. La configuration Jest permet ici de *mapper* les noms des modules lors d'un import javascript avec l'emplacement des fichiers.
...
Dans chaque dossier nous allons commencer à créer notre architecture. Le but du tutoriel n'étant pas la compréhension d'une architecture React/Redux, si vous le souhaitez je vous invite à lire [ceci](http://redux.js.org/docs/introduction/){:target="_blank" rel="nofollow"}.
...
Le [cache busting](https://www.keycdn.com/support/what-is-cache-busting/){:target="_blank" rel="nofollow"} est déjà intégré dans la configuration Webpack.
...
Vous pouvez aussi retrouver le code directement dans le projet [Infinite github](https://github.com/CaptainJojo/infinite) dans la branche [communication](https://github.com/CaptainJojo/infinite/tree/communication){:target="_blank" rel="nofollow"}.
...
Ensuite en suivant l'article [ici](http://symfony.com/doc/master/bundles/DoctrineFixturesBundle/index.html){:target="_blank" rel="nofollow"}, permettant de mettre en place des fixtures doctrine, vous pouvez ajouter dans votre `composer.json`
...
Vous pouvez aussi retrouver le code directement dans le projet [Infinite github](https://github.com/CaptainJojo/infinite){:target="_blank" rel="nofollow"} dans la branche `master`.
