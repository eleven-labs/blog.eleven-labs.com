...
excerpt: "Plusieurs astronautes de la galaxy d'Eleven Labs se sont rendus le 5 décembre dernier à l'Agile Tour organisé par Microsoft dans ses propres locaux."
authors:
    - mae
    - jbernard
    - rcourbo
...
L'enjeu de ce premier atelier animé par Natalia HELIE-SHILOVA était de comprendre l'importance de la communication transversale entre les différents services d'une entreprise. Qui peut se transposer dans notre quotidien par la communication entre les différentes équipes de nos projets agiles.

L'atelier consistait à la répartition des participants en cinq groupes, représentant des villes.
...
La première étape consistait à échanger entre villes par papier des profils dont nous avions besoin et de ceux que nous étions prêts à donner, afin de se mettre d'accord sur un échange.
...
Je pense aussi que cette technique peut permettre à un projet de sortir la tête de l'eau si celui-ci arrive à un moment critique où plus personne n'est d'accord sur les prochains jalons à prendre. 
...
Cette conférence présenté par Caroline AUPERT était un REX sur la transition du métier de développeur à celui de Scrum Master. Centré d’abord sur la transition, Caroline à pu nous expliquer à travers son expérience, que cela n’a pas toujours été facile.

Les différences avec le métier de développeur sont nombreuses et apportent beaucoup d'interrogations : comment savoir à court terme que l’on remplit bien son rôle ? Comment expliquer aux autres développeur de l’équipe qu’un Scrum Master peut les aider autrement qu’en les aidant à coder ? Enfin, et c’est surement la question qui à trouvé le plus d’écho dans la salle, que faire de ses journées quand il n’y a pas de meeting Scrum ?

Les réponses à ses question peuvent sembler évidente pour ceux qui auraient le recul de l'expérience, elles le sont beaucoup moins pour un Scrum Master junior.

  

Outre les différences évidentes avec son métier, Caroline nous a exposé les difficultés qu’elle a pu rencontrer. Les petites phrases bien senti de certains collègues, les passage à vide à se demander quoi faire et comment se former pour s'améliorer à pratiquer le Scrum Mastering.

  

Au final, ce fut un REX très intéressant, de nombreux développeur dans la salle se sont beaucoup reconnus aux expériences partagées.
...
Augmentation de la dette technique, évolutions trop complexes à mettre en place… Le temps de la remise en question vient donc au bout d'un an et une solution semble s'entrevoir : le Scrum en feature-team. 
...
Groupe de pair-programming, communication entre les développeurs et avec le client en continue. Bref, un manifesto des plus simples qui semble bien loin de la rigidité du Scrum… en apparence. 
Effectivement, en conclusion de sa présentation, Baptiste nous montre qu'en effet, chaque élément important de leur nouvelle organisation se rapproche des pierres angulaires du Scrum. Ainsi, sous des formes légèrement différentes, son équipe pratiquait le Daily meeting et autres rétrospective de fin de sprint.
...
L'idée de cette conférence donné par Amy WHICKER est que chaque fois que nous avons une émotion, qu'on pourrait qualifier de bonne ou de mauvaise, est un opportunité d'en tirer quelque chose.
...
De par cette peur instaurée, nous n’allons pas prendre de risques, ou alors être sûrs de les contrôler avant de se lancer. Ce qui empêche certaines créativités ou innovations de s’exprimer.

L’idée est donc de par la compréhension de la peur du risque, et d’un but commun entre les différentes équipes, de pouvoir arriver à l'enchainement suivant : 
- Identifier le risque business 
- Lister cinq raisons pour lesquelles ce risque nous fait peur 
- Quelles sont les idées pour répondre à ces peurs 
- Quels bénéfices espérer si nous suivons cette idée.
...
-   Une pour définir la story à décortiquer
    
-   Une pour définir les règles et contraintes liées à cette US
    
-   Une pour représenter les exemples qui sont associés à ces critères d’acceptances, afin de matérialiser plus concrètements pour chacun ces règles
    
-   Une pour les questions qui ont été posées mais qui n’ont pas pu avoir de réponses de la part de l’équipe
...
Elle permet également de se rendre compte quand une US est trop complexes et pourrait être découpée en plusieurs stories, car elle embarque trop de règles et de contraintes à la fois.
