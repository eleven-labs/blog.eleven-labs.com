...
Cette année encore, Eleven Labs et sa bande d'astronautes étaient partenaires de la [dotJS](http://www.dotjs.io/){:target="_blank" rel="nofollow noopener noreferrer"} version 2015.

![wilson](https://c1.staticflickr.com/1/593/23547337312_1589d2613a_h.jpg){:target="_blank" rel="nofollow noopener noreferrer"}


![](https://c1.staticflickr.com/1/759/23027109824_359b4a1a60_h.jpg)![](https://c1.staticflickr.com/1/626/23653922455_ecf5d0c6b0_k.jpg){:target="_blank" rel="nofollow noopener noreferrer"}
...
dotJS fait partie des dotConferences, dont mon collègue astronaute Martin Cadoux nous explique très clairement le concept dans [son article sur dotCSS](https://blog.eleven-labs.com/les-dotcss-2015-cetait-bien/){:target="_blank" rel="nofollow noopener noreferrer"} :
...
> Javascripters at [\#dotjs](https://twitter.com/hashtag/dotjs?src=hash) coffee break! Tabs vs spaces indentation discussion was not going to end well ⊙\_☉[@dotjs](https://twitter.com/dotJS) [pic.twitter.com/ivkvFMQjtM](https://t.co/ivkvFMQjtM){:target="_blank" rel="nofollow noopener noreferrer"}
>
> — gerardsans (@gerardsans) [7 Décembre 2015](https://twitter.com/gerardsans/status/673809192642220033){:target="_blank" rel="nofollow noopener noreferrer"}
...
[https://c2.staticflickr.com/6/5667/23025882214_242cee679a_k.jpg](https://c2.staticflickr.com/6/5667/23025882214_242cee679a_k.jpg){:target="_blank" rel="nofollow noopener noreferrer"}

------------------------------------------------------------------------

L’événement s’étalant sur toute la journée, voici donc un tour d’horizon rapide des différents talks.

![](https://c1.staticflickr.com/1/738/23656479935_b63777fc06_k.jpg){:target="_blank" rel="nofollow noopener noreferrer"}

**Modern Async JS** par [*Christophe Porteneuve*](https://twitter.com/porteneuve){:target="_blank" rel="nofollow noopener noreferrer"}
---------------------------------------------------------------------------------

Christophe Porteneuve nous présente ici plusieurs problématiques liées à l’utilisation de callback et du code asynchrone. Le fameux “Callbackhell”, qui comme son nom l’indique, peut vite devenir infernal, autant sur la compréhension que sur la maintenabilité du code. Celui-ci étant parfois difficile à prendre en main, les générateurs et les promises peuvent déjà nous y aider, en attendant les [fonctionnalités await/async d’ES7](https://jakearchibald.com/2014/es7-async-functions/){:target="_blank" rel="nofollow noopener noreferrer"}.

[Slides](http://tdd.github.io/dotjs-async/){:target="_blank" rel="nofollow noopener noreferrer"}

**Hyperdrive: p2p hash sharing tool** par [*Mathias Buus*](https://twitter.com/mafintosh){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------------------
...
Dépôt Github du projet : [https://github.com/mafintosh/hyperdrive](https://github.com/mafintosh/hyperdrive){:target="_blank" rel="nofollow noopener noreferrer"}

[Slides](https://github.com/mafintosh/slides/blob/gh-pages/dotjs-2015/README.md){:target="_blank" rel="nofollow noopener noreferrer"}

**Dealing with garbage** par [*Samuel Saccone*](https://twitter.com/samccone){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------

Samuel Saccone, développeur chez Google, aborde ensuite le sujet épineux des fuites mémoire et des performances (Illustré par quelques screenshots assez sympathiques). S’en suit une démonstration de l’utilisation de la console Chrome poussée, afin de détecter/fixer ces problèmes. Puis de la présentation de son outil de détection de fuite mémoire: [Drool](https://github.com/samccone/drool){:target="_blank" rel="nofollow noopener noreferrer"}.

Présentation drôle et très bien animée pour un sujet pas super passionnant de premier abord.

[Slides](https://docs.google.com/presentation/d/1uom69F6NGURHhrox1Ma50NW1nOKqdxRr0dKDNENwi6Y/edit#slide=id.gd530a4dd9_0_54){:target="_blank" rel="nofollow noopener noreferrer"}

À lire également, une présentation très intéressante d’Addy Osmani sur l’utilisation de la console Chrome [ici](http://addyosmani.com/blog/chrome-devtools-deepdive/){:target="_blank" rel="nofollow noopener noreferrer"}.

**HTTP/2 is here, now let's make it easy** par [*Rebecca Murphy*](https://twitter.com/rmurphey){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------------------------
...
[Slides](https://speakerdeck.com/rmurphey/2-is-here-now-lets-make-it-easy){:target="_blank" rel="nofollow noopener noreferrer"}

**LUNCH BREAK !**

![](https://c2.staticflickr.com/6/5725/23359640130_8bff265e02_h.jpg) ![](http://i.giphy.com/3GCLlNvCg61ji.gif){:target="_blank" rel="nofollow noopener noreferrer"}
...
##### **Publishing ES6 modules today** par [*Laurent Voyer*](https://twitter.com/rmurphey){:target="_blank" rel="nofollow noopener noreferrer"}
...
[Slides](http://slides.com/vvo/authoring-and-publishing-es6-modules-today-dotjs-2015){:target="_blank" rel="nofollow noopener noreferrer"}

##### **Mobile debugging with VorlonJS** par [*Etienne Margraff*](https://twitter.com/@meulta){:target="_blank" rel="nofollow noopener noreferrer"}
...
[Slides](http://fr.slideshare.net/emargraff/dotjs-lightning-talk-vorlonjs){:target="_blank" rel="nofollow noopener noreferrer"}

**Practical ES6** par [*Nicolas Bevacqua*](https://twitter.com/nzgb){:target="_blank" rel="nofollow noopener noreferrer"}
--------------------------------------------------------------------

Tour d’horizon sur les fondamentaux de ES6, avec une liste d’exemples expliqués de la nouvelle mouture d’EcmaScript. Rien de vraiment nouveau mais une piqûre de rappel nécessaire, détaillée dans [son article](https://ponyfoo.com/articles/es6){:target="_blank" rel="nofollow noopener noreferrer"}.
...
[Slides](https://speakerdeck.com/bevacqua/practical-es6-for-the-modern-javascript-tinkerer){:target="_blank" rel="nofollow noopener noreferrer"}

**Reactive Javascript** par [*André Staltz*](https://twitter.com/andrestaltz){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------

Sans doute l’une des présentations les plus intéressantes de la journée.
André Staltz y présente de manière très simple et précise la programmation reactive au travers de [RxJS](https://github.com/Reactive-Extensions/RxJS){:target="_blank" rel="nofollow noopener noreferrer"}. Ne connaissant pas le sujet, j’ai trouvé l’approche claire et les exemples particulièrement parlants, notamment le cycle de vie de deux variables liées et comment l’une affecterait l’autre, via la fonctionnalité “Observable”, sorte de promise améliorée.
Je vous incite vivement à regarder tout cela de plus près.
Une introduction est disponible [ici](https://gist.github.com/staltz/868e7e9bc2a7b8c1f754) et quelques vidéos [ici](https://egghead.io/series/introduction-to-reactive-programming){:target="_blank" rel="nofollow noopener noreferrer"}, afin d’approfondir le sujet.

Pendant ce temps-là, Wilson se promène un peu.

> Just made a new friend from [@Eleven\_Labs](https://twitter.com/Eleven_Labs) [\#dotJS](https://twitter.com/hashtag/dotJS?src=hash) [pic.twitter.com/dV5PjBm0qA](https://t.co/dV5PjBm0qA) — Adrien Trauth (@Nioufe) [7 Décembre 2015](https://twitter.com/Nioufe/status/673788757640921088){:target="_blank" rel="nofollow noopener noreferrer"}

**WebRTC** par [*Eric Schoffstall*](https://twitter.com/contrahacks){:target="_blank" rel="nofollow noopener noreferrer"}
--------------------------------------------------------------------

WebRTC est en passe de devenir un nouveau standard pour tout ce qui est connexion peer-to-peer entre navigateurs sans passer par un serveur, celui-ci étant assez attendu par la communauté vu les possibilités qu’il propose (Communication par voix ou vidéo par exemple). Cependant, seuls Chrome, Firefox et Opera proposent cette implémentation ([Voir en détails](http://caniuse.com/#search=webrtc)){:target="_blank" rel="nofollow noopener noreferrer"}.
Après avoir travaillé sur la compatibilité sur chaque navigateur (y compris IE9 et mobile) et en regroupant les différentes solutions apportées sur chacune des plateformes, Eric annonce la création de sa nouvelle librairie [rtc-everywhere](https://github.com/contra/rtc-everywhere){:target="_blank" rel="nofollow noopener noreferrer"}. Magique !

> "If you decided your stuff only works on Chrome Desktop, you're not making a product you're building a demo" - [@contrahacks](https://twitter.com/contrahacks) at [\#dotJS](https://twitter.com/hashtag/dotJS?src=hash){:target="_blank" rel="nofollow noopener noreferrer"}
>
> — ChristophePorteneuve (@porteneuve) [7 Décembre 2015](https://twitter.com/porteneuve/status/673876828663230465){:target="_blank" rel="nofollow noopener noreferrer"}

En bonus: Eric postule également au poste de maire de San Francisco...

![](http://i.giphy.com/KTHFxuEtrVoGI.gif){:target="_blank" rel="nofollow noopener noreferrer"}

**Jade &gt; Pug** par [*Forbes Lindesay*](https://twitter.com/forbeslindesay){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------
...
**Teaching Kids to Code** par [*Tim Caswell et son fils de 9 ans*](https://twitter.com/creationix){:target="_blank" rel="nofollow noopener noreferrer"}
--------------------------------------------------------------------------------------------------

Présentation amusante du développement pour plus jeunes, et sur ce qui est possible en dehors d’un navigateur web.

[Slides](https://gist.github.com/creationix/507719a418be365c7631){:target="_blank" rel="nofollow noopener noreferrer"}

**Pocked sized JS** par [*Henrik Joreteg*](https://twitter.com/HenrikJoreteg){:target="_blank" rel="nofollow noopener noreferrer"}
-----------------------------------------------------------------------------
...
>
> — Dominic Tarr (@dominictarr) [8 Août 2015](https://twitter.com/dominictarr/status/629992939738005504){:target="_blank" rel="nofollow noopener noreferrer"}
...
[Slides](https://slides.joreteg.com/dotjs/){:target="_blank" rel="nofollow noopener noreferrer"}

**No title** par [*Brendan Eich*](https://twitter.com/brendaneich){:target="_blank" rel="nofollow noopener noreferrer"}
------------------------------------------------------------------
...
> So impressed when [@BrendanEich](https://twitter.com/BrendanEich) demo'ed what web assembly is capable of in [\#firefox](https://twitter.com/hashtag/firefox?src=hash) [\#wasm](https://twitter.com/hashtag/wasm?src=hash) [\#dotjs](https://twitter.com/hashtag/dotjs?src=hash) [pic.twitter.com/sTGDdkHKMr](https://t.co/sTGDdkHKMr) — Perry Mitchell (@perry\_mitchell) [8 Décembre 2015](https://twitter.com/perry_mitchell/status/674242616096104448){:target="_blank" rel="nofollow noopener noreferrer"}
...
![](http://i.giphy.com/kRWFIgO75okHm.gif){:target="_blank" rel="nofollow noopener noreferrer"}

Les photos de l’événement sont disponibles sur le [compte Flickr](https://www.flickr.com/photos/97226415@N08/sets/72157661549425069/){:target="_blank" rel="nofollow noopener noreferrer"}
