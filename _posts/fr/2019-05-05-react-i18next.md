...
Étant donné que nous travaillons sur un site multi-langue, nous souhaitons que la langue préférée de l'utilisateur soit automatiquement détectée. De façon générale, il s'agît de la langue du navigateur. Pour ceci, nous allons ajouter une dépendance :
