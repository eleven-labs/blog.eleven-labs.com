...
Pour PSR-1 et PSR-2, il y a [PHP Code Sniffer](https://github.com/squizlabs/PHP_CodeSniffer "Github.com PHP Code Sniffer"){:target="_blank" rel="nofollow"}. Cet outil va se baser sur un ensemble de règles, parcourir le code et afficher toutes les erreurs. Les règles peuvent être enrichies selon les spécificités du framework.
...
Pour ne pas entrer dans cette mauvaise pratique, il y a [PHP Copy/Paste Detector](https://github.com/sebastianbergmann/phpcpd "Github PHP CPD"){:target="_blank" rel="nofollow"}. Il détecte les parties de codes qui ont été dupliquées.
...
[PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer "Github PHP CS Fixer"){:target="_blank" rel="nofollow"} va permettre de corriger toutes les erreurs de formatage du code de manière automatisée. Il s'intéresse aux recommandations PSR-1 et PSR-2.
...
[SonarQube](http://www.sonarqube.org/){:target="_blank" rel="nofollow"} est un projet libre de droit qui permet de vérifier et contrôler la qualité du code. C'est une solution tout-en-un.

### SensioLab Insight

[SensioLab Insight](https://insight.sensiolabs.com/){:target="_blank" rel="nofollow"} est un service en SASS. Principalement orienté vers Symfony 2, il s'adapte également au projet PHP sans framework.
...
Encore un autre outil Sensio, mais très efficace dans l'analyse des performances d'une application. [Blackfire.io](https://blackfire.io/){:target="_blank" rel="nofollow"} va permettre de cibler les points faibles : consommation mémoire, CPU, disque et réseau.
