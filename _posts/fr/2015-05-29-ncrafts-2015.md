...
Ayant pour habitude d'aller aux sfPots et sfLives parisiens, j'ai voulu sortir de ma zone de confort en allant à une conférence organisée principalement par une partie de la communauté .Net: [NCrafts](http://ncrafts.io/){:target="_blank" rel="nofollow"}. C'est une conférence internationale autour du *Software Craftsmanship* qui cherche à réunir les *craftsmen* et *craftswomen* d’Europe et d’ailleurs. On y a parlé de code, d’apprentissage, d’expérience, de bonnes pratiques de développement.

Toutes les vidéos sont disponibles [ici](http://videos.ncrafts.io/){:target="_blank" rel="nofollow"}.

Les *talks* qui m'ont le plus marqué
====================================

### "*Continuous delivery - the missing parts*" par [Paul Stack](https://twitter.com/stack72){:target="_blank" rel="nofollow"}

([slides](https://speakerdeck.com/stack72/continuous-delivery-the-missing-parts)) ([vidéo](https://vimeo.com/130216882)){:target="_blank" rel="nofollow"}
...
### "*Crafted Design - an introduction to Interaction-Driven Design (IDD)*" par [Sandro Mancuso](https://twitter.com/sandromancuso){:target="_blank" rel="nofollow"}

([slides](http://www.slideshare.net/sandromancuso/crafted-design-ljc-world-tour-mash-up-2014)) ([vidéo](https://vimeo.com/130256611)){:target="_blank" rel="nofollow"}
...
### "*The Silver Bullet Syndrome*" par [Hadi Hariri](https://twitter.com/hhariri){:target="_blank" rel="nofollow"}

([vidéo](https://vimeo.com/130202574)){:target="_blank" rel="nofollow"}
...
### "*Layers considered Harmful*" par [Christian Horsdal](https://twitter.com/chr_horsdal){:target="_blank" rel="nofollow"}
