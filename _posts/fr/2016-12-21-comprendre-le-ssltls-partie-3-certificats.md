...
Un **certificat électronique** (aussi appelé **certificat numérique** ou **certificat de clé publique**) peut être vu comme une carte d'[identité](https://fr.wikipedia.org/wiki/Identit%C3%A9_num%C3%A9rique_(Internet)){:target="_blank" rel="nofollow"} numérique. Il est utilisé principalement pour identifier et authentifier une personne physique ou morale, mais aussi pour chiffrer des échanges.
...
Les autorités de certification sont des organismes enregistrés et certifiés auprès d'autorités publiques et/ou de [gouvernance de l'Internet](https://fr.wikipedia.org/wiki/Gouvernance_d%27Internet){:target="_blank" rel="nofollow"} qui établissent leur viabilité comme intermédiaire fiable.
...
Nous allons prendre par exemple le meilleur site au monde (oui c’est bientôt mon point individuel de fin d’année donc…  :p ) [https://eleven-labs.com](https://eleven-labs.com){:target="_blank" rel="nofollow"}.
...
* X.509, défini dans la RFC [5280](https://tools.ietf.org/html/rfc5280){:target="_blank" rel="nofollow"} ;
* OpenPGP, défini dans la [RFC 4880](https://tools.ietf.org/html/rfc4880RFC){:target="_blank" rel="nofollow"}.
