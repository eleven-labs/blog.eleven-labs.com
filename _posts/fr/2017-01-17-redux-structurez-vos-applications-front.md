...
Historiquement, le besoin s'est fait sentir sur [React](https://facebook.github.io/react/) et Facebook a donc ouvert les sources de son outil [Flux](http://facebook.github.io/flux/){:target="_blank" rel="nofollow noopener noreferrer"}.
...
Dan Abramov a donc lancé, en juin 2015, [Redux](http://redux.js.org){:target="_blank" rel="nofollow noopener noreferrer"}, qui permet principalement de simplifier la gestion du store car il y a en effet qu'un seul store pour toute votre application dans Redux.

Tous vos composants peuvent donc accéder à vos données.

Pour plus d'informations sur les différences Redux / Flux, je vous invite à lire cette [réponse de Dan](http://stackoverflow.com/questions/32461229/why-use-redux-over-facebook-flux/32920459#32920459){:target="_blank" rel="nofollow noopener noreferrer"}.
