...
On a fini par découvrir Codeception ([http://codeception.com/](http://codeception.com/)) qui est une solution de test écrit en PHP et qui possède beaucoup de modules (AMQP, Doctrine2, Filesystem, MongoDb, REST, Symfony,...){:target="_blank" rel="nofollow"}.
...
- Acceptance [http://codeception.com/docs/03-AcceptanceTests](http://codeception.com/docs/03-AcceptanceTests){:target="_blank" rel="nofollow"}
- Functional [http://codeception.com/docs/04-FunctionalTests](http://codeception.com/docs/04-FunctionalTests){:target="_blank" rel="nofollow"}
- Unit [http://codeception.com/docs/05-UnitTests](http://codeception.com/docs/05-UnitTests){:target="_blank" rel="nofollow"}
...
Je vous invite à aller lire la [doc de codeception](http://codeception.com/docs/), elle est assez complète et vous pourrez voir qu'ils supportent pas mal de modules :){:target="_blank" rel="nofollow"}
