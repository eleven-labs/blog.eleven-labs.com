...
Voici un exemple d’offre d’emploi issu du site [eleven-labs.com](http://www.eleven-labs.com){:target="_blank" rel="nofollow noopener noreferrer"} :
...
- [Schema.org](http://schema.org){:target="_blank" rel="nofollow noopener noreferrer"}
- [Introduction to Structured Data](https://developers.google.com/structured-data/){:target="_blank" rel="nofollow noopener noreferrer"}

Google propose également un [outil d'analyse](http://www.google.com/webmasters/tools/richsnippets){:target="_blank" rel="nofollow noopener noreferrer"} de vos pages à la recherche qui détecte le schéma utilisé et vous fait un rapport sur les données trouvées, leur formatage ainsi que les éventuelles erreurs rencontrées.
