...
Ici nous utiliserons [Humbug](https://github.com/padraic/humbug){:target="_blank" rel="nofollow noopener noreferrer"}, un framework parmi d’autres qui permet de faire des tests de mutation en PHP.
...
Je ne vais pas tout détailler ici, si vous voulez en savoir plus je vous invite à consulter la [page GitHub du projet](https://github.com/padraic/humbug){:target="_blank" rel="nofollow noopener noreferrer"}.
