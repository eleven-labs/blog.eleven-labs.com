...
Quelles ont été les erreurs dans la gestion de ces projets ? Qui ont peut-être même fait couler de nombreuses sociétés ? Quelles possibilités existent pour éviter de reproduire ces mêmes erreurs ?

### Les 3 grandes illusions de la gestion de projet

Il est important de prendre conscience que certaines idées préconçues dans la gestion de projet agile sont fausses. Et peuvent mettre en péril un projet ou un produit. L’agilité est une méthodologie qui s’applique de manière réfléchie, adaptative et non unilatéralement.
...
- Dans le cas d’un contexte projet centré autour de la production de livraisons

	- engager les différents acteurs du projet à écrire pour chacun son objectif des prochaines livraisons à son niveau

	- créer un tableau avec ces différents objectifs

- Dans le cas d’un contexte projet centré autour du recadrage d’un problème
...
- Dans le cas d’un contexte projet où la vision est biaisée par des solutions déjà définies

	- mettre en avant un exemple simplifié d’un impact mapping

- Dans le cas d’un contexte projet basé sur un changement de business
...
L’avantage de ces Vanity Metrics est justement qu’elles permettent de mettre en avant ce que l’on souhaite mettre en avant, même s’il ne s’agit pas de metrics réellement engageantes vis à vis de son service ou d’un produit.

Ce qui en fait toute son utilité en terme de business. En France et en Allemagne, il est plus important pour le commun des personnes d’avoir raison que de gagner.
...
-   D’avoir des décideurs impliqués pour que les actions suivent tout de suite après
