...
---
Savoir utiliser RxSwift dans son projet iOS est bon à savoir et à mettre en place. Parmi ses avantages est d'améliorer l'expérience utilisateur ainsi une bonne gestion des threads.

RxSwift est une librairie qui va permettre d’écrire un code asynchrone d’une manière plus concise et compacte. Il est basé sur les observables qui eux, une séquence de data à laquelle on peut réagir comme par exemple dans le cas où un utilisateur appuie sur un bouton. Le préfixe Rx en RxSwift désigne “ReactiveX”.
...
​
​Dans cet article, nous aborderons tout d'abord la programmation réactive. Ensuite nous explorons les observables et comment s'y inscrire. Enfin, nous verrons ce que sont les subscribers.  
​

## Programmation  réactive

La programmation réactive est un paradigme de programmation réactive c’est-à-dire un modèle de programmation basé sur des événements en utilisant une séquence d’observables.

Dans la programmation réactive, on crée un flux de données c’est-à-dire des données disponibles au fils du temps qui réalisent de manière ordonnée des actions X ou Y.  On peut diviser ce flux en deux parties, la première partie considérée la source d’émissions des données qui les émet lorsque cette deuxième partie est en train de l’écouter pour pouvoir récupérer cette émission.

​Dans les parties qui suivent, je vais traiter les Observables qui sont le coeur du RxSwift ainsi que les Subjects. 
​
​
## Les Observables
​
...
Les observables sont une séquence d'éléments qui peuvent émettre des valeurs. Ses valeurs peuvent être des Int, String ou bien un autre Object.

​Imaginons que l'observable soit une chaîne youtube et que les observers soit des abonnés, à chaque fois qu'une vidéo sera ajouté à la chaine, les abonnés seront notifiés de son arrivée.
​
...
​
​Si on souscrit à ses éléments, on aura les valeurs 1, 2 et 3. Le type de l’observable dans ce cas est Observable&lt;Int&gt;.
​
...
​
​
Là on vient de créer nos observables qui émettent les events, c’est quoi la prochaine étape ? 
​

La prochaine étape est automatiquement recevoir ce qui a été émis, les observers. En un autre terme: “To subscribe”
 
​
## Subscribing
​
Quand on souscrit à un observable, on reçoit les événements émis par l’observable. 
​
...
​
Passons à la pratique. Dans le premier exemple on utilisera dispose() et le deuxième DisposeBag()
​
```Swift
...
​
(2): Si on exécute, on ne verra pas la souscription. La raison est qu’on a créé la subscription après avoir créé l’événement (il n'y a pas des subscribers ). Mais si on a créé l’événement après la souscription, on peut du coup les récupérer.
​
...
Behavior Subject est à peu près similaire à Publish Subjects. La seule différence est que pour qu’il puisse être initialisé, on doit au moins lui passer une valeur initiale.  

Notez que dans le premier exemple, le subscriber a été initialisé avec la valeur “First” et il n’y avait pas d’autres événements avant la souscription. C’est donc la seule valeur prise en compte avant la souscription. Or dans ce deuxième exemple, deux events ont eu lieu avant la souscription et le seul event pris en compte est le plus récent qui est “Before Subscribing 2” 
​
...
## Conclusion
​
C’est tout pour cette première partie sur RxSwift. J’espère que c’était une première découverte de RxSwift et spécialement de ce que sont les Observables, les Subscribers ainsi que les Subjects. Une deuxième partie arrivera bientôt où je traiterai des “Filtering Operators”, “Transforming Operators” ainsi que des “Combing Operators”. Stay tuned !
