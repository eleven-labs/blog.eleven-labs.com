...
Dans le monde PHP, le gestionnaire de dépendances le plus utilisé est [composer](http://getcomposer.org/){:target="_blank" rel="nofollow noopener noreferrer"}, fortement
inspiré de [npm](https://www.npmjs.com/) pour node et [bundler](http://bundler.io/){:target="_blank" rel="nofollow noopener noreferrer"} pour ruby, il installe les
...
[getenv](http://php.net/manual/fr/function.getenv.php){:target="_blank" rel="nofollow noopener noreferrer"}.
...
>
> [Source](http://php.net/manual/fr/features.commandline.webserver.php){:target="_blank" rel="nofollow noopener noreferrer"}
...
Le composant [console](https://github.com/symfony/console){:target="_blank" rel="nofollow noopener noreferrer"} de Symfony facilite la création et le test de tâches
d'administrations.
