...
Il s’agissait ensuite essentiellement du live coding d’une application de suivi de la station ISS par[ datastream.io](http://www.datastream.io/){:target="_blank" rel="nofollow"}
...
Pour plus d’information n’hésitez pas à suivre Dan Abramov, ou à lire la documentation de Redux. Sinon, v[ous pouvez aussi revoir sa présentation](https://docs.google.com/presentation/d/1QBpt07SEN0lhjwuMdirfws-TRKTruXvxxu3-t6DiGk4/pub?start=false&loop=false&delayms=3000&slide=id.g8608bf710_2_0){:target="_blank" rel="nofollow"}.
...
[Sa présentation est disponible si vous le souhaitez](http://talks.pixelastic.com/css-flags-bestofweb/#/){:target="_blank" rel="nofollow"}.
...
Vous pouvez aussi [retrouver son talk](https://docs.google.com/presentation/d/1ZtyIiOLueJUZ89E0Zb0tluv7yKfQ91xqs2LqLr_ydBU/pub?start=false&loop=false&delayms=3000&slide=id.p){:target="_blank" rel="nofollow"}.
...
Il a également développé [start9.io](http://www.start9.io){:target="_blank" rel="nofollow"} pour héberger ses jeux, jouer et sauvegarder ses parties endiablées !
...
Pour les curieux, ses travaux [sont accessibles sur GitHub](https://github.com/LostInBrittany/beyond-polymer){:target="_blank" rel="nofollow"}.
