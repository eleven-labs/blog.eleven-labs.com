...
- [AWS Certificate Manager](https://aws.amazon.com/fr/certificate-manager/){:target="_blank" rel="nofollow"}
- [Amazon S3](https://aws.amazon.com/fr/s3/){:target="_blank" rel="nofollow"}
- [Amazon Cloudfront](https://aws.amazon.com/fr/cloudfront/){:target="_blank" rel="nofollow"}

> Pour simplifier les interactions avec AWS, nous allons utiliser `aws-cli` afin de ne pas nous perdre dans son interface
> web chargée.
> Un [guide d'installation](http://docs.aws.amazon.com/fr_fr/cli/latest/userguide/installing.html){:target="_blank" rel="nofollow"} est disponible sur la
> [documentation officielle](https://aws.amazon.com/fr/documentation/){:target="_blank" rel="nofollow"}.
...
merge sur la branche master du [repository](https://github.com/eleven-labs/blog.eleven-labs.com){:target="_blank" rel="nofollow"} grâce à Travis CI.
