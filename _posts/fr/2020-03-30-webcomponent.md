...
```
Comme on peut le voir la classe étend HTMLElement, elle va donc non seulement hériter de toutes les méthodes et propriétés d'HTMLElement et être considéré comme tel.
