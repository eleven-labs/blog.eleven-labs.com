...
<Reminder variant="warning" title="Disclaimer">

Oui, la Clean regroupe des concepts qui permettent justement de s'affranchir du Framework, afin d'en être le plus agnostique possible.<br />
...
Souvent, on reste très attachés à la règle et aux dogmes quand on débute sur un sujet.<br />
