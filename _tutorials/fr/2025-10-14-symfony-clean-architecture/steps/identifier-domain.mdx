...
Comme pour tous les exemples de ce tutoriel, le contenu des classes n'est pas exhaustif. Pour voir le code dans son intégralité, gardez en parallèle une [page Github](https://github.com/ArthurJCQ/leitner-box/tree/refacto-clean) ouverte avec le code complet de notre application.
