...
À partir de maintenant, sur le [repo Github](https://github.com/ArthurJCQ/leitner-box/tree/refacto-clean) de l'application, vous pouvez switcher sur la branche `refacto-clean` pour découvrir le projet entièrement réécrit en Clean.
