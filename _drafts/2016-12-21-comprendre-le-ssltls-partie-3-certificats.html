...
<p><span style="font-weight: 400;">Un </span><b>certificat électronique</b><span style="font-weight: 400;"> (aussi appelé </span><b>certificat numérique</b><span style="font-weight: 400;"> ou </span><b>certificat de clé publique</b><span style="font-weight: 400;">) peut être vu comme une carte d'</span><a href="https://fr.wikipedia.org/wiki/Identit%C3%A9_num%C3%A9rique_(Internet)"><span style="font-weight: 400;">identité numérique</span></a><span style="font-weight: 400;">. Il est utilisé principalement pour identifier et authentifier une personne physique ou morale, mais aussi pour chiffrer des échanges.</span></p>
<p><span style="font-weight: 400;">Il est </span><b>signé</b><span style="font-weight: 400;"> par un tiers de confiance (aussi appelé </span><b>autorités de certification, AC</b><span style="font-weight: 400;"> ou </span><b>CA</b><span style="font-weight: 400;"> pour </span><b>Certificate Authority</b><span style="font-weight: 400;"> en anglais</span><span style="font-weight: 400;">) qui atteste du lien entre l'identité physique et l'entité numérique.</span></p>
...
<p><span style="font-weight: 400;">C'est cette relation qui est à la base de la </span><b>chaîne de confiance</b><span style="font-weight: 400;">. Ces clés sont appelées </span><i><span style="font-weight: 400;">c</span></i><span style="font-weight: 400;">lés</span><b> publiques racines</b><span style="font-weight: 400;"> ou </span><a href="https://fr.wikipedia.org/wiki/Certificat_racine"><span style="font-weight: 400;">certificats racines</span></a><span style="font-weight: 400;"> et sont utilisées pour identifier les clés publiques d'autres organismes (nous allons voir en détail cette partie plus bas).</span></p>
<p><span style="font-weight: 400;">Cependant, les CA doivent répondre à des critères de sécurité très stricts, notamment pour garantir que leurs propres certificats ne sont pas compromis, ce qui entraînerait la corruption de tous les certificats émis sous leur responsabilité. C'est pourquoi la clé privée de leur certificats root est mise à l'abri, et n'est pas utilisée pour </span><b>signer</b><span style="font-weight: 400;"> des certificats SSL, mais pour </span><b>signer</b><span style="font-weight: 400;"> des certificats </span><b>intermédiaires</b><span style="font-weight: 400;">, qui à leur tour signent les certificats SSL finaux.</span></p>
<p><span style="font-weight: 400;">C’est le terme “</span><b>chaîne de confiance” </b><span style="font-weight: 400;">(</span><span style="font-weight: 400;">que nous avons décrit plus haut) qui désigne ceci.</span></p>
...
<li style="font-weight: 400;">La hiérarchie du certificat ! On voit clairement que le certificat intermédiaire d’Eleven-labs qui est émis par Let’s Encrypt Authority X3 est <b>signé </b><span style="font-weight: 400;">par DST Root CA X3</span></li>
</ol>
...
<h4><b>Normes de certificat :</b></h4>
...
<h4><b>"Signature" ? "Certificat signé" ?</b></h4>
<p><span style="font-weight: 400;">Tout d’abord la fonction de signature doit répondre à plusieurs critères :</span></p>
<ul>
<li style="font-weight: 400;"><b>Authentique</b><span style="font-weight: 400;"> : L'identité du signataire doit pouvoir être retrouvée de manière certaine ;</span></li>
<li style="font-weight: 400;"><b>Infalsifiable</b><span style="font-weight: 400;"> : La signature ne peut pas être falsifiée. Quelqu'un ne peut se faire passer pour un autre ;</span></li>
<li style="font-weight: 400;"><b>Non réutilisable</b><span style="font-weight: 400;"> : La signature n'est pas réutilisable. Elle fait partie du document signé et ne peut être déplacée sur un autre document ;</span></li>
<li style="font-weight: 400;"><b>Inaltérable</b><span style="font-weight: 400;"> : Un document signé est inaltérable. Une fois qu'il est signé, on ne peut plus le modifier ;</span></li>
<li style="font-weight: 400;"><b>Irrévocable</b><span style="font-weight: 400;"> : La personne qui a signé ne peut le nier.</span></li>
</ul>
...
<ul>
<li style="font-weight: 400;"><b>Domain Validation (DV)</b><span style="font-weight: 400;"> : Il authentifie uniquement le nom de domaine : il s’agit du certificat le plus répandu (c’est le cas de Let’s Encrypt).</span></li>
<li style="font-weight: 400;"><b>Business Validation (BV) ou Organization Validation (OV)</b><span style="font-weight: 400;"> : Vous devez fournir à l’autorité de certification des documents officiels concernant votre entreprise ou association (KBis, Journal officiel, etc.). Après vérification, l’autorité émet un certificat qui relie votre domaine à votre entreprise. Le client peut alors voir sur son navigateur que le site correspond bien à votre société.</span></li>
<li style="font-weight: 400;"><b>Extended Validation (EV)</b><span style="font-weight: 400;"> : Le plus exigeant en terme de certification (documents, délai d’émission, budget) mais aussi le plus rassurant pour vos clients et pour lutter contre le phishing, généralement utilisé par les grandes entreprises du fait de son coût élevé, il met clairement en avant votre société dans le navigateur (à côté de la barre d’adresse).</span></li>
</ul>
...
<li>Créer vous même un certificat dit <b>auto-signé</b>.</li>
</ol>
...
<h4><b>Portée du certificat :</b></h4>
<ul>
...
<li style="font-weight: 400;"><span style="font-weight: 400;">Domaine + sous-domaine (</span><b>wildcard</b><span style="font-weight: 400;">) : idéal pour votre site web et les autres services.<br />
