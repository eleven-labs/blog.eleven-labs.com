...
Cela dit, les critères pour atteindre le niveau A s'additionnent à ceux du niveau AA, et il en va de même pour atteindre une conformité AAA. Même si dans cette article on n'inclut pas une explication exhaustive sur chaque critère de chaque niveau, n'hésitez pas à lire la documentation existante soit sur la page WCAG ou même MDN. Entre les critères choisis, nous pouvons trouver des **implémentations pour le design et l'implémentation du code**. Voyons quelques exemples suivant les principes POUR.
