...
<p><b>3 - Certificate (optionnel)</b></p>
...
<p><b>7 - Certificate (optionnel)</b></p>
<p><span style="font-weight: 400;">Certificat éventuel du client si le serveur demande une authentification.</span></p>
<p><b>8 - Client Key Exchange</b></p>
<p><span style="font-weight: 400;">Le client produit un secret pré-maître (encrypted pre-master key) et le crypte avec la clé publique du certificat du serveur. Ces informations sont chiffrées une deuxième fois avec la clé publique du serveur (et non la clé publique du certificat du serveur) reçue dans le message </span><b>Server Key Exchange </b><i><span style="font-weight: 400;">(cf. étape 5)</span></i><span style="font-weight: 400;">.</span></p>
<p><i><span style="font-weight: 400;">Exemple :</span></i></p>
<p><span style="font-weight: 400;">Secure Socket Layer</span><span style="font-weight: 400;"><br />
...
<p><b>9 - Certificate Verify (optionnel)</b></p>
...
<p><b>11 - Client Finished</b></p>
<p><span style="font-weight: 400;">Fin des émissions du client, ce message est chiffré à l'aide des paramètres de la suite de chiffrement.</span></p>
<p><i><span style="font-weight: 400;">Exemple :</span></i></p>
<p><span style="font-weight: 400;">Secure Socket Layer</span><span style="font-weight: 400;"><br />
...
<p><b>14 - Encrypted Data</b></p>
<p><span style="font-weight: 400;">Le tunnel SSL / TLS est établi, c'est maintenant le </span><b>Record Protocol</b><span style="font-weight: 400;"> qui prend le relais pour chiffrer les données.</span></p>
{% endraw %}
