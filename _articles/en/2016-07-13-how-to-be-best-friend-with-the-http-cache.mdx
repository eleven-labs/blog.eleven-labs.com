...
| --- | --- |
| [Firefox](https://fr.wikipedia.org/wiki/Firefox) | <Kbd>Ctrl</Kbd> + <Kbd>F5</Kbd> |
| [Chrome](https://fr.wikipedia.org/wiki/Chrome) | <Kbd>Ctrl</Kbd> + <Kbd>F5</Kbd> or <Kbd>Shift</Kbd> + <Kbd>F5</Kbd> or <Kbd>Ctrl</Kbd> + <Kbd>Shift</Kbd> + <Kbd>N</Kbd> |
| [Safari](https://fr.wikipedia.org/wiki/Safari_(logiciel)) | <Kbd>Ctrl</Kbd> + <Kbd>Alt</Kbd> + <Kbd>E</Kbd> |
| [Internet Explorer](https://fr.wikipedia.org/wiki/Internet_Explorer) | <Kbd>Ctrl</Kbd> + <Kbd>F5</Kbd> |
| [Opera](https://fr.wikipedia.org/wiki/Opera) | <Kbd>Ctrl</Kbd> + <Kbd>F12</Kbd> |
