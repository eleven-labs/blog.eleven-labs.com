...
<Figure src="{BASE_URL}/imgs/articles/2024-05-20-crossplane-kubernetes/schema_crossplane_end_users.svg" alt="Schéma d'interfaçage entre les différents concepts Crossplane">Schéma d'interfaçage entre les différents concepts Crossplane</Figure>
...
<YouTube id="S2BQz-5cboA" title="Crossplane Intro and Deep Dive - the Cloud Native Control Plane Framework" />
