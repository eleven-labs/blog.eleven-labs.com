...
Pour plus d'informations sur YCM, regardez [la doc de son créateur !](https://github.com/Valloric/YouCompleteMe)
...
N'hésitez pas à parcourir le site [Vimawesome](https://vimawesome.com/) qui est une référence pour trouver des plugins adaptés à votre contexte de travail. Ce tutoriel utilise Pathogen comme gestionnaire de plugins.
