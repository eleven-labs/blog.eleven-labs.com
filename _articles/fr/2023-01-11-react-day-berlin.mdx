...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/kosmos-place.jpg" alt="Kosmos place">Le site Kosmos prêt pour le premier jour du React Day Berlin. *Crédit photo : GitNation.*</Figure>
...
<Reminder variant="info" title="Bénévole ? Qu'est-ce-que c'est ?">
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/react-day-berlin-1.jpg" alt="Variété de goodies avec le logo React Day, tels que des autocollants et des badges.">Autocollants, épingles et badges prêts. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/kosmos.jpg" alt="Mur en pierre blanche et détails en jaune, noir, vert et rouge avec des lettres bleues.">Intérieur de la salle principale de Blade Runner. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/sous-verre.jpg" alt="Trois sous-verre avec le logo d'Internet Explorer, JavaScript et TypeScript">Sous-verres thématiques pour les participants. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/breakfast.jpg" alt="Trois plateaux en métal avec de la nourriture sur une table blanche.">Pâtisseries du petit-déjeuner. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/mnemonic.jpg" alt="Salle avec plusieurs sièges bleus et une scène avec le logo React Day Berlin">Intérieur de la deuxième salle Mnemonic. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/blade-runner-track.jpg" alt="Porte en métal avec un panneau bleu">Extérieur de la salle principale. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/graf.jpg" alt="Homme en pull blanc parlant sur une scène avec un écran géant">Nik Graf lors de sa présentation. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/koppers.jpg" alt="Salle avec vue sur l'écran d'information, le présentateur avec un t-shirt noir à gauche sur scène prenant la parole.">Tobias Kopper lors de sa présentation. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/koppers2.jpg" alt="Salle pleine illuminée de lumière bleue et le présentateur sur scène.">La situation de Webpack selon Tobias Kopper. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/bostian.jpg" alt="Femme en longue robe noire sur podium donnant la présentation.">Emma Bostian lors de sa présentation. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/bostian2.jpg" alt="Salle pleine avec le présentateur sur le podium et les participants assis.">*Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/after-party.jpg" alt="Trois hommes discutant et dansant dans la chambre noire avec des accessoires lumineux.">Accessoires, musique techno et des jeux de société. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/team.jpg" alt="L'équipe sur scène saluant et souriant à la caméra.">L'équipe GitNation, speakers et assistants sur la photo finale. *Crédit photo : GitNation.*</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2023-01-11-react-day-berlin/swag-bag.jpg" alt="Sac en tissu bleu avec un imprimé blanc">La phrase du React Day Berlin "Build code not walls". *Crédit photo : GitNation.*</Figure>
