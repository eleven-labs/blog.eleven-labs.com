...
<Figure src="{BASE_URL}/imgs/articles/2022-11-22-mission-accessible/disabilities.jpg?width=600" alt="Exemple de situation d’handicap permanent, temporaire et situationnel">Source [Accessibility Guidelines de Avinash Kaur](https://uxdesign.cc/accessibility-guidelines-for-a-ux-designer-c3ba775539be)</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2022-11-22-mission-accessible/group.png?width=600" alt="Exemple de situation d’handicap permanent, temporaire et situationnel">Source [Accessibility Guidelines de Avinash Kaur](https://uxdesign.cc/accessibility-guidelines-for-a-ux-designer-c3ba775539be)</Figure>
...
<Figure src="{BASE_URL}/imgs/articles/2022-11-22-mission-accessible/layout.png?width=600" alt="HTML structuré de manière sémantique et prévisible en utilisant les éléments tels que Menu, en-tête, titre, sous-titre, article, image, etc.">Source [How to structure your HTML properly for Web Accessibility](https://digital.com/how-to-create-a-website/how-to-properly-structure-your-html-for-web-accessibility/)</Figure>
