...
Les règles ESLint personnalisées permettent d'améliorer la qualité du code en imposant des conventions spécifiques à votre équipe ou projet. Dans notre cas, nous allons créer une règle qui interdit l'utilisation des styles inline dans les composants React, favorisant ainsi l'utilisation de solutions plus maintenables comme l'utilisation de classe utilitaires ou les CSS modules.

<div class="admonition info" markdown="1"><p class="admonition-title">À retenir</p>

Les styles inline en React peuvent entraîner des problèmes de maintenance, de performance et de cohérence visuelle. Notre règle ESLint aidera à maintenir une meilleure séparation des préoccupations dans le code.
</div>
