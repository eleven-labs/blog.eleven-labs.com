...
<Figure src="{BASE_URL}/imgs/articles/2022-03-04-nestjs-le-cycle-de-vie-dune-requete/nest-logo.png?width=300" alt="NestJS logo">*NestJS Framework*</Figure>
...
<Reminder variant="info" title="Niveaux de déclaration possibles">
...
<Reminder variant="note" title="Comment ça marche ?">
