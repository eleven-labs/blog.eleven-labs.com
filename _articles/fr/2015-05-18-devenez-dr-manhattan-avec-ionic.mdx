...
-   La documentation [http://ionicframework.com/docs/](http://ionicframework.com/docs/)
-   Le forum [http://forum.ionicframework.com/](http://forum.ionicframework.com/)
-   Une collection d’extension pour AngularJS [http://ngcordova.com/](http://ngcordova.com/)
-   Un live chat [https://gitter.im/driftyco/ionic](https://gitter.im/driftyco/ionic)
-   Un service de gestion de ses applications (envoi de notification push, mise à jour de l’application sans deploiement sur les stores, outils d’analityques, etc)  [https://apps.ionic.io/](https://apps.ionic.io/)
-   Une application pour le partage et la prévisualisation de vos applications avec vos testeurs [http://view.ionic.io/](http://view.ionic.io/)
-   Un “playground” pour apprendre et tester les différentes parties du framework sans se soucier des difficultés de compilation et déploiement [http://play.ionic.io/](http://play.ionic.io/)
-   Un outil de création en ligne pour livrer rapidement des prototypes [https://creator.ionic.io](https://creator.ionic.io)
