...
On a fait le plus gros du travail maintenant, téléchargez la dernière version de [Elasticsearch HTTP](https://www.elastic.co/downloads/elasticsearch).
...
Si vous allez sur [http://localhost:9200/](http://localhost:9200/) dans votre navigateur ou que vous tapez dans votre terminal :
```bash
