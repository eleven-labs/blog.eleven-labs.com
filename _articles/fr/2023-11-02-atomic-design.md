...
```
<div class="admonition info" markdown="1"><p  class="admonition-title">En résumé</p>

Un composant du Système doit être "**pur**", sans aucune information associée au contenu réel, que ce soit dans son nom, qui doit être générique, ou dans sa capacité à gérer toutes les données reçues.
</div>
