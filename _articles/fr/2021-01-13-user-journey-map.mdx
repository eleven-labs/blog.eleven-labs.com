...
![Template de Customer Journey Map]({BASE_URL}/imgs/articles/2021-01-13-user-journey-map/user-journey-map-template.png)
...
![Exemple de customer Journey Map sur un site d'annonces immobilières]({BASE_URL}/imgs/articles/2021-01-13-user-journey-map/user-journey-map-exemple.png)
